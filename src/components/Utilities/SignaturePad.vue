<template>
    <div id="container">
        <canvas></canvas>
        <div v-if="editable">
            <v-btn v-if="!signatureEmpty" small dark color="error" class="mx-2" @click="clear">
                <v-icon class="mr-2">mdi-close</v-icon> Clear
            </v-btn>
            <v-btn v-if="active && !signatureEmpty" small dark color="primary" class="mx-2" @click="save">
